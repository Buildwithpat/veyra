...
export const faqs: Faq[] = [
  {
    ...
    answer:
      "Veyra connects two sides of the textile trade: buyers — garment manufacturers, fashion brands, boutique owners and retailers — and suppliers, including fabric mills, wholesalers and distributors looking to reach verified buyers.",
  },
  {
    id: "faq-02",
